    ...
    info               =
      {
        ...
        title*         = {Cross-domain knowledge graph \\ represents learning research},
%%%%% ------------------------------------------------------------------- %%%%%
...
\begin{document}
%%----------- 主体部分 ----------- %%
\include{pages/chapter1_my}
\include{pages/chapter2_my_new}
\include{pages/chapter3_my_new}
\include{pages/chapter4_my_new}
% \include{pages/chapter3_my}
\include{pages/chapter5_my_new}
\include{pages/chapter6_my_new}
